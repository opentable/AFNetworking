...
Pod::Spec.new do |s|
  ...
  # this may no longer be necessary -- need to confirm after network code upgrade is done
...
EOS
  ...
  # note that the following subspec dependencies must reference "AFNetworking-OpenTable" and not "AFNetworking" or else a pod update will end up pulling both "AFNetworking" and "AFNetworking-OpenTable" pods.
